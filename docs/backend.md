...
## 3.1. Estructura de Aplicaciones
...
## 3.2. API REST (Django REST Framework)
...
## 3.3. Vistas y Renderizado (Django Templates + HTMX)
...
*   **DataPointDataFrameBuilder**: Clase utilitaria para convertir QuerySets de Django en DataFrames de Pandas de manera eficiente.
*   **Operaciones**:
